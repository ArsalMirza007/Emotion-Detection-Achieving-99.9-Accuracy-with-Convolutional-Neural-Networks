# -*- coding: utf-8 -*-
"""Emotion Detection: Achieving 99.9% Accuracy with Convolutional Neural Networks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CaPIEQ4GIW1t2NL04sLCOQzMuKnvOO9I
...
def train_happy_sad_model(train_generator):
    ...
    model = tf.keras.models.Sequential([
        tf.keras.layers.Conv2D(32, (3, 3), activation='relu', input_shape=(150, 150, 3)),  # Correct input_shape
    ...
    history = model.fit(x=train_generator,
                        epochs=15,  # Ensure the model achieves 99.9% accuracy before 15 epochs
                        callbacks=[callbacks]
                       )
